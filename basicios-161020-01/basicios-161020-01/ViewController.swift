...
class ViewController: UIViewController {
    ...
    @IBAction func abtnCalc(_ sender: UIButton) {
        ...
        if (kiemtra_ngaythang == "OK")
        {
            let arrNgayThang: Array<String> = ngaythang.components(separatedBy: "/")
            let iNgay:Int = Int(arrNgayThang[0])!
            let iThang:Int = Int(arrNgayThang[1])!
            let iNam:Int = Int(arrNgayThang[2])!
        ...
        {
            lblResult.text = kiemtra_ngaythang
    ...
    func Kiem_Tra_NgayThang(ngaythang: String) -> String{
        ...
        if (ngaythang != "")
        {
            ...
            let iNgay:Int = Int(arrNgayThang[0])!
            let iThang:Int = Int(arrNgayThang[1])!
            let iNam:Int = Int(arrNgayThang[2])! // try catch error
