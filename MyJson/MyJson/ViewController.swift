...
extension ViewController: UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imgHinhKhoaHoc.loadImageOnline(urlString: arrHinhKhoaHoc[indexPath.row])
//        let arr = arrHinhKhoaHoc[indexPath.row].components(separatedBy: "/")
//        print(arr[2])
//        cell.imgHinhKhoaHoc.image = UIImage(named: arr[2])
